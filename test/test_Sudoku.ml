...
let test_empty_board () =
  let board = create () in
  check bool "Empty board" false (Board_validation.is_board_solved board)
...
let test_solved_board () =
  ...
  in
  check bool "Valid board solved" true (Board_validation.is_board_solved board)
...
let test_duplicate_numbers_in_row () =
  ...
  check bool "Duplicate numbers in row" false
    (Board_validation.is_board_solved board)
...
let test_invalid_range_board () =
  ...
  in
  check bool "Invalid range board" false
    (Board_validation.is_board_solved board)
...
let test_all_same_number_board () =
  ...
  in
  check bool "All same number board" false
    (Board_validation.is_board_solved board)
